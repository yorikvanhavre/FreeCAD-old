...
class CommandCompoundExtended:
    ...
    def Activated(self):
        ...
        FreeCADGui.doCommand('obj = FreeCAD.ActiveDocument.addObject("Path::FeatureCompoundPython","Compound")')
        FreeCADGui.doCommand('PathScripts.PathCompoundExtended.ObjectCompoundExtended(obj)')
        if incl:
