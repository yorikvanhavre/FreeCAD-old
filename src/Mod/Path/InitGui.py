...
<<<<<<< HEAD
        ...
        # build commands list
        commands = ["Path_Profile","Path_Pocket","Path_Drilling","Path_Dressup","Path_Hop","Path_Shape","Path_Compound","Path_Project","Path_Fixture"]
=======
        from PathScripts import PathCopy
        
        # build commands list
        commands = ["Path_Profile","Path_Pocket","Path_Drilling","Path_Dressup","Path_Hop","Path_Shape","Path_Copy","Path_Compound","Path_Project"]
>>>>>>> af18281ed2adb0e807c0de16e0777e20aab6ab15
